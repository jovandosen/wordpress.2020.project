 ...
 */
 ...
 {
 	register_setting('reading', 'example_setting_name');

 	add_settings_section(
        'example_settings_section',
        'Example Settings Section',
        'example_settings_section_cb',
        'reading'
    );

    add_settings_field(
        'example_settings_field',
        'Example Setting',
        'example_settings_field_cb',
        'reading',
        'example_settings_section'
    );
 }

 add_action('admin_init', 'add_example_data');

 function example_settings_section_cb()
 {
    echo '<p>Example Section Introduction.</p>';
 }

 function example_settings_field_cb()
 {
    // get the value of the setting we've registered with register_setting()
    $setting = get_option('example_setting_name');
    // output the field
    ?>
    <input type="text" name="example_setting_name" value="<?php echo isset( $setting ) ? esc_attr( $setting ) : ''; ?>">
    <?php
 }
